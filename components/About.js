  ...
  return (
    <div className="bg-white/70 md:h-[90vh] rounded-md shadow-2xl mx-auto lg:mx-[2rem] my-[2rem] p-[2rem] w-[90%] lg:w-[60%] text-black h-fit">
      <div className="">
        ...
        <div className="text-black tracking-wider flex flex-col justify-center items-center gap-5 min-[300px]:leading-7 md:leading-10 xl:leading-10 2xl:leading-[3rem]">
